...
type ZStorageFile struct {
	path string
	sync.RWMutex
	context *ZContext
}

func NewFileStorage(c *ZContext) *ZStorageFile {
...
func (z *ZStorageFile) SaveImage(data []byte) (string, error) {
	var result error
	result = nil
...
func (z *ZStorageFile) NewImage(saveName string, data []byte) error {
	var result error
	result = nil
...
func (z *ZStorageFile) GetImage(request *ZRequest) ([]byte, error) {
	var result error
	var data []byte
...
func (z *ZStorageFile) InfoImage(md5 string) (*ZImageInfo, error) {
	var result error
	result = nil
